...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link  active" href="/album">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="/photo">
          ...
          <span class="nav-link-text ms-1">photo</span>
        </a>
      </li>
      <li class="nav-item">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                      <span class="badge badge-sm bg-gradient-success">{{ $item->auteur }}</span>
                    </td>
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold">{{ $item->photo }}</span>
                    </td>
                    <td class="align-middle d-flex gap-2">
                      ...
                      <a href="{{ route("album.edit",$item->id) }}" class="btn btn-primary">edit</a>
              ...
              <a href="{{ route('album.create') }}" class="btn">create</a>
            </div>
          </div>
        </div>
      </div>
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="d-flex px-2">
                        <div>
                          <img src="{{ asset('/img/small-logos/logo-spotify.svg') }}" class="avatar avatar-sm rounded-circle me-2" alt="spotify">
                        </div>
                        <div class="my-auto">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2">
                        <div>
                          <img src="{{ asset('/img/small-logos/logo-invision.svg') }}" class="avatar avatar-sm rounded-circle me-2" alt="invision">
                        </div>
                        <div class="my-auto">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2">
                        <div>
                          <img src="{{ asset('img/small-logos/logo-jira.svg') }}" class="avatar avatar-sm rounded-circle me-2" alt="jira">
                        </div>
                        <div class="my-auto">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2">
                        <div>
                          <img src="{{ asset('/img/small-logos/logo-webdev.svg') }}" class="avatar avatar-sm rounded-circle me-2" alt="webdev">
                        </div>
                        <div class="my-auto">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2">
                        <div>
                          <img src="{{ asset('/img/small-logos/logo-xd.svg') }}" class="avatar avatar-sm rounded-circle me-2" alt="xd">
                        </div>
                        <div class="my-auto">
