                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body px-0 pt-0 pb-2">
                                <div class="table-responsive p-0">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($photos as $item)
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            ...
                                                            <div>
                                                                ...
                                                                <form action="{{ route('photo.favori',$item->id) }}" method="post">
                                                                    @csrf
                                                                    @if ($item->favori === 'non')
                                                                        <button style="background-color: transparent; border: none" type="submit"><i
                                                                                class="fa-solid fa-star-half-stroke mx-2"></i></button>
                                                                    @endif
                                                                    @if ($item->favori === 'favori')
                                                                        <button style="background-color: transparent; border: none"  type="submit"><i class="fa-solid fa-star text-warning"></i></button>
                                                                    @endif
                                                                </form>
                                                            </div>
                                                            <div class="d-flex flex-column justify-content-center">
                                                    ...
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0">{{ $item->lien }}</p>

                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span
                                                            class="badge badge-sm bg-gradient-success">{{ $item->album }}</span>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span
                                                            class="badge badge-sm bg-gradient-success">{{ $item->favori }}</span>
                                                    </td>
                                    ...
                                    <a href="{{ route('photo.create') }}" class="btn">create</a>
                                </div>
                            </div>
                        </div>
                    </div>
