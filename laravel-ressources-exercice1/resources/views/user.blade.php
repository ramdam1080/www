                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body px-0 pt-0 pb-2">
                                <div class="table-responsive p-0">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th
                                                    class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                                     nombres album</th>
                                                <th class="text-secondary opacity-7"> button</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($user as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0">{{ $item->age }} ans</p>
                                                        
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="badge badge-sm bg-gradient-success">{{ $item->naissance }}</span>
                                                    </td>
                                                    ...
                                                    <td class="align-middle text-center d-flex gap-2">
                                                      <form action="{{ route("user.destroy",$item->id) }}" method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button class="bg-danger p-1">delete</button>
                                                      </form>
                                    ...
                                    <a href="{{ route("user.create") }}" class="btn btn-waring">create</a>
                                </div>
                            </div>
                        </div>
                    </div>
